            ...
            <VStack paddingLeft={26} paddingRight={26}>
                <HStack marginTop={4} alignItems={"center"} >
                    <HStack flex={1}>
                        ...
                        <Text color={COLORS.lightGrey} style={{
                            ...FONTS.body6,
                            marginLeft: 5
                        }}>#ID00001</Text>
                    </HStack>
                    ...
                    <HStack alignItems={"center"}>
                        ...
                        <VStack space={5} >
                            <VStack>
                                ...
                                <Text style={styles.titleText}>Pickup - KTX Khu B ĐHQG, Đông Hòa, Dĩ An, Bình Dương</Text>

                            </VStack>
                            <VStack>
                                <Text style={styles.detailText}>UIT</Text>
                                <Text style={styles.titleText}>Destination - Trường Đại học Công nghệ Thông tin - ĐHQG TP..</Text>
                            </VStack>
                        </VStack>
                    </HStack>
                    <HStack style={{ marginHorizontal:26, marginVertical:15, alignItems: 'center', justifyContent: 'center' }}>
                        <TouchableOpacity onPress={() => { onClickReject }} style={{
                            ...
                            <Text bold color={COLORS.red} fontSize={20} styles={{ ...FONTS.h3 }}>Reject</Text>
                        </TouchableOpacity>
                        <View style={{ flex: 1, justifyContent: 'flex-end', alignItems: 'flex-end' }}>
                            <TouchableOpacity onPress={() => { onClickAccept }} style={{
                            ...
                            <Text bold color={COLORS.white} fontSize={20} styles={{ ...FONTS.h3 }}>Accept</Text>
