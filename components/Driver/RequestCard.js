            ...
            <View h={140} style={{ backgroundColor: COLORS.tertiary, justifyContent: 'center', padding: 20, borderRadius: 20 }}>
                <VStack space={1} style={{ marginVertical: 10 }} >
                    ...
                    <HStack>
                        ...
                        <Flex flex={1} style={{justifyContent:'flex-end', alignItems: 'flex-end' }}>
                            <HStack >
                                <View style={{
                                    alignContent:'center'
                                }}>
                                    <TouchableOpacity onPress={()=>{onClickReject}} style={{
                                        ...
                                        <Text bold color={COLORS.red} styles={{...FONTS.h5}}>Reject</Text>
                                    </TouchableOpacity>
                                </View>
                                <View style={{
                                    alignItems: 'flex-end',
                                    ...
                                    <Text bold color={COLORS.white} styles={{...FONTS.h5}}>Accept</Text>
                                    </TouchableOpacity>
                                </View>
                            </HStack>
                        </Flex>
