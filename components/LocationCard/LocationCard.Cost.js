...
const LocationCardCost = () => {
  return (
    <View bgColor={'#0B0F2F'} w={'100%'} h={370} borderTopRadius={20} shadow={3} position={'absolute'} bottom={0} padding={'30px 25px 0 25px'}>
      <VStack space={4}>
        <HStack w={'100%'}>
          <VStack space={2}>
            <VStack space={1}>
        ...
        <HStack space={2}>
          <VStack space={3}>
            <HStack space={3}>
              <Image w={'25px'} h={'25px'} source={MapIcon} alt='' alignSelf={'center'} />
              <Text fontSize={SIZES.h4} color={'white'} bold>2km</Text>
            </HStack>
            <HStack space={3}>
              <Image w={'25px'} h={'25px'} source={ClockIcon} alt='' alignSelf={'center'} />
              <Text fontSize={SIZES.h4} color={'white'} bold>5mins</Text>
            </HStack>
          </VStack>
          <VStack marginLeft={'auto'}>
            <Text fontSize={SIZES.h2} color={'white'} bold>20,000đ</Text>
            <Text fontSize={SIZES.h5} color={'#808080'} strikeThrough textAlign={'right'}>20,000đ</Text>
          </VStack>
        </HStack>
        <HStack>
